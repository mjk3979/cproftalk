...
tests: test_linkedlist test_parser test_lexer test_evaluator test_env
...
test_evaluator: evaluator.o lexer.o parser.o linkedlist.o env.o test_evaluator.c
	gcc $(CFLAGS) -c test_evaluator.c
	gcc $(CFLAGS) -o test_evaluator test_evaluator.o lexer.o parser.o linkedlist.o evaluator.o env.o

env: env.h env.c
	gcc $(CFLAGS) -c env.c

test_env: env.o test_env.c linkedlist.o parser.o lexer.o
	gcc $(CFLAGS) -c test_env.c
	gcc $(CFLAGS) -o test_env test_env.o parser.o lexer.o env.o linkedlist.o
